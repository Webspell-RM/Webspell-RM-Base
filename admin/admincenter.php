        ...
        <ul class='nav navbar-top-links navbar-right'>
          ...
          <li class='dropdown'>
            <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
              <i class="fas fa-times"></i> Logout <i class="fas fa-caret-down"></i>
            </a>
            <ul class='dropdown-menu dropdown-user'>
              <li>
                <a href='../index.php'><i class="fas fa-undo"></i> Back to Website</a>
              </li>
              <li class='divider'></li>
              <li>
                <a href='/includes/modules/logout.php'><i class="fas fa-sign-out-alt"></i> Logout</a>
              </li>
            </ul>
            <!-- /.dropdown-user -->
          </li>
          ...
          <div class='sidebar-nav navbar-collapse'>
            <ul class='nav' id='side-menu'>
              <li class='sidebar-head'>
                <a class='nav-link link-head' href='admincenter.php'> <i class="fas fa-home"></i> Dashboard</a>
              </li>
             
              <?php 
              #echo admincentercat(10); 
                echo dashnavi();
