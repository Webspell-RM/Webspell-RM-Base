...
$ergebnis = safe_query("SELECT * FROM ".PREFIX."navigation_dashboard_links WHERE modulname='content_head_moduls'");
...
if ($action == "add") {
  ...
  <div class="panel-heading">
                            <i class="fas fa-tasks"></i> Content Head Module
                        </div>
...
';
  ...
  echo'<a href="admincenter.php?site=settings_content_head_moduls&amp;action=add" class="btn btn-primary" type="button">' . $_language->module[ 'new_modul' ] . '</a><br /><br />';
    ...
    <thead>
      ...
      <th style="width: 20%"><img style="width: 250px;" class="img-thumbnail" src="../images/plugins/layout-head-content.jpg"><br><b>'.$_language->module['activated'].'</b></th>
      
      <th style="width: 30%"><img style="width: 250px;" class="img-thumbnail" src="../images/plugins/layout-head-content-ohne.jpg"><br><b>'.$_language->module['deactivated'].'</b></th>
      <th style="width: 25%"></th>
    </thead></table>
  ...
  <table id="plugini" class="table table-bordered table-striped dataTable">
	...
	$moduls = safe_query("SELECT * FROM " . PREFIX . "settings_content_head_moduls");
    $CAPCLASS = new \webspell\Captcha;
    $CAPCLASS->createTransaction();
    $hash = $CAPCLASS->getHash();
