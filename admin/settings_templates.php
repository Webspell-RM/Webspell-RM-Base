...
if (isset($_GET[ 'delete' ])) {
    ...
    if ($CAPCLASS->checkCaptcha(0, $_GET[ 'captcha_hash' ])) {
        ...
        safe_query("DELETE FROM " . PREFIX . "plugins_widgets WHERE themes_modulname='" . $_GET[ 'modulname' ] . "' ");
        safe_query("DELETE FROM " . PREFIX . "settings_module WHERE themes_modulname='" . $_GET[ 'modulname' ] . "' ");
...
<div class="col-md-12">
  ...
  <div class="form-group">
    <label class="col-md-2 control-label">'.$_language->module['template_name'].':</label>
    <div class="col-md-8"><span class="text-muted small"><em>
      <input type="text" class="form-control" name="name" value="'.getinput($ds['name']).'" / readonly></em></span>
    </div>
  </div>
