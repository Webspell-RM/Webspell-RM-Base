...
// CSS / JS
	...
	$components_css=""; $components_js="";
	foreach ($components['css'] as $component) { $components_css .= '<link href="' . $component . '" rel="stylesheet">'; }
	foreach ($components['js'] as $component) { $components_js .= '<script src="' . $component . '"></script>'; }
