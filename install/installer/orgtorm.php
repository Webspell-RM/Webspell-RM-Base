...
function update_org_rm208_1($_database)
{
...
$transaction->addQuery("ALTER TABLE `" . PREFIX . "challenge` RENAME TO `" . PREFIX ."plugins_challenge`");
#$transaction->addQuery("DROP TABLE IF EXISTS `" . PREFIX . "clanwars`"); #clanwars entfernt
$transaction->addQuery("ALTER TABLE `" . PREFIX . "clanwars` RENAME TO `" . PREFIX ."plugins_clanwars`");
...
function update_org_rm208_2($_database)
{
...
function update_org_rm208_3($_database)
{
    $transaction = new Transaction($_database);
...
function update_org_rm208_4($_database)
{
    $transaction = new Transaction($_database);
...
function update_org_rm208_5($_database)
{
    $transaction = new Transaction($_database);
...
function update_org_rm208_6($_database)
{
    $transaction = new Transaction($_database);
...
function update_org_rm208_7($_database)
{
    $transaction = new Transaction($_database);
...
(26, 5, '{[de]}Datenbank{[en]}Database{[it]}Database', 'ac_database', 'admincenter.php?site=database', 'any', 9),
(27, 5, '{[de]}Webspell-RM Update{[en]}Webspell-RM Update{[it]}Aggiornamento Webspell-RM', 'ac_update', 'admincenter.php?site=update', 'any', 10),
...
function update_org_rm208_8($_database)
{
    $transaction = new Transaction($_database);
