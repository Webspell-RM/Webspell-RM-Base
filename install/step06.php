...
?>
		...
		<div class="card">
			...
			<?php
                ...
                <?php echo $text; ?>
                <div id="result" style="display:none;"><h3><?=$type;?></h3>
                    <center><div class="pull-right"><a class="btn btn-primary btn-margin btn-orange" href="../index.php"><?=$_language->module['view_site']; ?></a></div>
                    </center>
                </div>
				<?php
