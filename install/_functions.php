...
(1, 1, '{[de]}Server-Info{[en]}Overview', '', 'admincenter.php?site=overview', 'any', 1),
(2, 1, '{[de]}Seiten Statistiken{[en]}Page Statistics', '', 'admincenter.php?site=page_statistic', 'any', 2),
(3, 1, '{[de]}Besucher Statistiken{[en]}Visitor Statistics', '', 'admincenter.php?site=visitor_statistic', 'any', 3),
(4, 2, '{[de]}Registrierte Benutzer{[en]}Registered Users', '', 'admincenter.php?site=users', 'forum', 1),
(5, 2, '{[de]}Teams{[en]}Squads', '', 'admincenter.php?site=squads', 'user', 2),
(6, 2, '{[de]}Clanmitglieder{[en]}Clanmembers', '', 'admincenter.php?site=members', 'user', 3),
(7, 2, '{[de]}Kontakte{[en]}Contacts', '', 'admincenter.php?site=contact', 'user', 4),
(8, 3, '{[de]}Geblockte Inhalte{[en]}Blocked Content', '', 'admincenter.php?site=spam&amp;action=forum_spam', 'user', 1),
(9, 3, '{[de]}Nutzer l&ouml;schen{[en]}Remove User', '', 'admincenter.php?site=spam&amp;action=user', 'user', 2),
(10, 3, '{[de]}Multi-Accounts{[en]}Multi-Accounts', '', 'admincenter.php?site=spam&amp;action=multi', 'user', 3),
(11, 3, '{[de]}gebannte IP`s{[en]}banned IP`s', '', 'admincenter.php?site=banned_ips', 'user', 4),
(12, 4, '{[de]}Einstellungen{[en]}Settings', '', 'admincenter.php?site=settings', 'page', 1),
(13, 4, '{[de]}Button{[en]}Button', '', 'admincenter.php?site=settings_buttons', 'feedback', 3),
(14, 4, '{[de]}Style{[en]}Style', '', 'admincenter.php?site=settings_styles', 'page', 2),
(15, 4, '{[de]}Module{[en]}Module', '', 'admincenter.php?site=settings_moduls', 'page', 4),
(19, 4, '{[de]}.css{[en]}.css', '', 'admincenter.php?site=settings_css', 'page', 5),
(20, 4, '{[de]}Themes{[en]}Themes', '', 'admincenter.php?site=settings_templates', 'page', 7),
(21, 4, '{[de]}Logo{[en]}Logo', '', 'admincenter.php?site=settings_logo', 'page', 6),
(22, 5, '{[de]}Admincenter Navigation{[en]}Admincenter Navigation', '', 'admincenter.php?site=dashboard_navigation', 'page', 1),
(23, 5, '{[de]}Webseiten Navigation{[en]}Webside Navigation', '', 'admincenter.php?site=webside_navigation', 'page', 2),
(24, 5, '{[de]}Startseite{[en]}Start Page', '', 'admincenter.php?site=settings_startpage', 'page', 3),
(25, 5, '{[de]}Statische Seiten{[en]}Static Pages', '', 'admincenter.php?site=settings_static', 'page', 4),
(27, 5, '{[de]}Spiele{[en]}Games', '', 'admincenter.php?site=settings_games', 'page', 5),
(28, 5, '{[de]}Mod-Rewrite{[en]}Mod-Rewrite', '', 'admincenter.php?site=modrewrite', 'page', 6),
(29, 5, '{[de]}E-Mail{[en]}E-Mail', '', 'admincenter.php?site=email', 'page', 7),
(30, 6, '{[de]}Plugin Manager{[en]}Plugin Manager', '', 'admincenter.php?site=plugin-manager', 'page', 1),
(31, 6, '{[de]}Plugin Installer{[en]}Plugin Installer', '', 'admincenter.php?site=plugin-installer', 'page', 2),
(32, 6, '{[de]}Themes Installer{[en]}Themes Installer', '', 'admincenter.php?site=template-installer', 'page', 3),
(33, 6, '{[de]}Widget Verwaltung{[en]}Widget Control', '', 'admincenter.php?site=plugin-widgets', 'page', 4)");
...
(1, 'about_us.html', 'index.php?site=about_us', 'a:0:{}', 'index\\.php\\?site=about_us', 'about_us.html', 'about_us\\.html', 'index.php?site=about_us'),
...
(73, 'partners.html', 'index.php?site=partners', 'a:0:{}', 'index\\.php\\?site=partners', 'partners.html', 'partners\\.html', 'index.php?site=partners'),
(74, 'streams.html', 'index.php?site=streams', 'a:0:{}', 'index\\.php\\?site=streams', 'streams.html', 'streams\\.html', 'index.php?site=streams'),
(75, 'forum_topic/{topicID}/{type}/{page}.html', 'index.php?site=forum_topic&topic={topicID}&type={type}&page={page}', 'a:3:{s:7:\"topicID\";s:6:\"string\";s:4:\"type\";s:6:\"string\";s:4:\"page\";s:7:\"integer\";}', 'index\\.php\\?site=forum_topic[&|&amp;]*topic=(\\w*?)[&|&amp;]*type=(\\w*?)[&|&amp;]*page=([0-9]+)', 'forum_topic/$3/$4/$5.html', 'forum_topic\\/(\\w*?)\\/(\\w*?)\\/([0-9]+?)\\.html', 'index.php?site=forum_topic&topic=$1&type=$2&page=$3'),
(76, 'news/{page}.html', 'index.php?site=news&page={page}', 'a:1:{s:4:\"page\";s:7:\"integer\";}', 'index\\.php\\?site=news[&|&amp;]*page=([0-9]+)', 'news/$3.html', 'news\\/([0-9]+?)\\.html', 'index.php?site=news&page=$1'),
(77, 'shoutbox.html', 'index.php?site=shoutbox_content&action=showall', 'a:0:{}', 'index\\.php\\?site=shoutbox_content[&|&amp;]*action=showall', 'shoutbox.html', 'shoutbox\\.html', 'index.php?site=shoutbox_content&action=showall'),
(78, 'calendar.html', 'index.php?site=calendar', 'a:0:{}', 'index\\.php\\?site=calendar', 'calendar.html', 'calendar\\.html', 'index.php?site=calendar'),
(79, 'streams/{streamID}.html', 'index.php?site=streams&id={streamID}', 'a:1:{s:8:\"streamID\";s:7:\"integer\";}', 'index\\.php\\?site=streams[&|&amp;]*id=([0-9]+)', 'streams/$3.html', 'streams\\/([0-9]+?)\\.html', 'index.php?site=streams&id=$1'),
...
#==========================================#
#Update von RM 2.0.1 auf RM 2.0.1
#==========================================#
...
$transaction->addQuery("ALTER TABLE `" . PREFIX . "navigation_dashboard_categories` ADD fa_name varchar(255) NOT NULL DEFAULT ''"); #fa_name hinzugefügt
$transaction->addQuery("INSERT INTO `" . PREFIX . "navigation_dashboard_categories` (`catID`, `name`, `fa_name`, `accesslevel`, `default`, `sort`) VALUES
(1, '{[de]}Hauptteil{[en]}Main Panel', 'fas fa-chart-bar', 'any', 0, 1),
(2, '{[de]}Benutzer Administration{[en]}User Administration', 'fas fa-users', 'user', 0, 2),
(3, '{[de]}Spam{[en]}Spam', 'fas fa-exclamation-triangle', 'user', 0, 3),
...
#Module in einer Datenbank zusammen gefügt / alte gelöscht
...
$transaction->addQuery("ALTER TABLE `" . PREFIX . "settings_moduls` ADD head_activated` int(11) NOT NULL DEFAULT '0'"); #head_activated hinzugefügt
$transaction->addQuery("ALTER TABLE `" . PREFIX . "settings_moduls` ADD content_head_activated` int(11) NOT NULL DEFAULT '0'"); #content_head_activated hinzugefügt
$transaction->addQuery("ALTER TABLE `" . PREFIX . "settings_moduls` ADD content_foot_activated` int(11) NOT NULL DEFAULT '0'"); #content_foot_activated hinzugefügt
...
$transaction->addQuery("ALTER TABLE `" . PREFIX . "plugins_widgets` ADD modulname` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT ''"); #content_foot_activated hinzugefügt# modulname hinzugefügt
