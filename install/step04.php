...
<form method="post">
    <div class="card">
        ...
        <?=$_language->module['what_to_do']; ?>
            ...
            <div class="radio">
                <label>
                    <input type="radio" name="installtype" value="org"> <?=$_language->module['update_org_202']; ?>
                </label><br>
                <label>
                    <input type="radio" name="installtype" value="nor"> <?=$_language->module['update_125_202']; ?>
                </label><br>
                <label>
