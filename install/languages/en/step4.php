...
$language_array = array(
    ...
    'write_failed'=>'It was not possible to write to the file. Please make sure that your web server has write access to the sql.php (CHMOD 777). <br>
         If no sql.php is available rename the sqlsample.php to sql.php and update your browser!.'
);
?>
