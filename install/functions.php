...
(5, '{[de]}Systemverwaltung{[en]}System Management{[it]}Gestione sistema', 'fas fa-cogs', 'page', 0, 5),
(6, '{[de]}Plugin Verwaltung{[en]}Plugin Administration{[it]}Gestione Plugin', 'fas fa-puzzle-piece', 'page', 0, 6),
(7, '{[de]}Plugins Webseiteninhalt{[en]}Plugins Website Content{[it]}Contenuto Plugin', 'fas fa-folder', 'page', 0, 7),
(8, '{[de]}Plugins System / Social Media{[en]}Plugins System / Social Media{[it]}Gestione Plugin / Social Media', 'fas fa-share-alt', 'page', 0, 8),
...
(26, 5, '{[de]}Impressum{[en]}Imprint{[it]}Sigla Editoriale', '', 'admincenter.php?site=settings_imprint', 'page', 8),
...
(1, 'Navigation Default', 'navigation_default', '{[de]}Mit diesem Plugin k&ouml;nnt ihr euch die Default Navigation anzeigen lassen.{[it]}Con questo plugin è possibile visualizzare la navigazione predefinita.', '', 1, 'T-Seven', 'https://webspell-rm.de', '', 'widget_navigation_default', '', '1.2', 'includes/plugins/navigation_default/')"); 
...
$transaction->addQuery("INSERT INTO `" . PREFIX . "plugins` (`pluginID`, `name`, `modulname`, `description`, `admin_file`, `activate`, `author`, `website`, `index_link`, `sc_link`, `hiddenfiles`, `version`, `path`) VALUES
('', 'Navigation Default', 'navigation_default', '{[de]}Mit diesem Plugin k&ouml;nnt ihr euch die Default Navigation anzeigen lassen.{[it]}Con questo plugin è possibile visualizzare la navigazione predefinita..', '', 1, 'T-Seven', 'https://webspell-rm.de', '', 'widget_navigation_default', '', '1.2', 'includes/plugins/navigation_default/')");
...
(2, '{[de]}Benutzer Administration{[en]}User Administration{[it]}Amministrazione Utenti', 'fas fa-users', 'user', 0, 2),
(3, '{[de]}Spam{[en]}Spam{[it]}Spam', 'fas fa-exclamation-triangle', 'user', 0, 3),
(4, '{[de]}Layout{[en]}Layout{[it]}Disposizione / Grafica / Grafica', 'far fa-image', 'cash', 0, 4),
...
$transaction->addQuery("INSERT INTO `" . PREFIX . "settings_imprint` (`imprintID`, `imprint`, `disclaimer_text`) VALUES
(1, '<p>{[de]} Impressum in deutscher Sprache.<br /><span style=color:#c0392b><strong>Konfigurieren Sie bitte Ihr Impressum!</strong></span></p><p>{[en]} Imprint in English.<br /><span style=color:#c0392b><strong>Please configure your imprint!</strong></span></p><p>{[it]} Sigla Editoriale in Italiano.<br /><span style=\"color:#c0392b\"><strong>Si prega di configurare l&rsquo;impronta Editoriale!</strong></span></p>', '<p>{[de]} Haftungsausschluss in deutscher Sprache.<br /><span style=color:#c0392b><strong>Konfigurieren Sie bitte Ihr Haftungsausschluss!</strong></span></p><p>{[en]} Disclaimer in English.<br /><span style=color:#c0392b><strong>Please configure your disclaimer!</strong></span></p><p>{[it]} {[it]} Dichiarazione di non Responsabilità in Italiano.<br /><span style=\"color:#c0392b\"><strong>Si prega di configurare la Dichiarazione di non Responsabilità!</strong></span></p>')");
...
$transaction->addQuery("INSERT INTO `" . PREFIX . "navigation_website_sub` (`snavID`, `mnavID`, `name`, `modulname`, `url`, `sort`, `indropdown`) VALUES
('', 5, '{[de]}Datenschutz-Bestimmungen{[en]}Privacy Policy{[it]}Informativa sulla Privacy', 'privacy_policy', 'index.php?site=privacy_policy', 1, 1),
('', 5, '{[de]}Impressum{[en]}Imprint{[it]}Sigla Editoriale', 'imprint', 'index.php?site=imprint', 1, 1)");
