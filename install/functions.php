...
$transaction->addQuery("INSERT IGNORE INTO `" . PREFIX . "settings_buttons` (`buttonID`, `button1`, `button2`, `button3`, `button4`, `button5`, `button6`, `button7`, `button8`, `button9`, `button10`, `button11`, `button12`, `button13`, `button14`, `button15`, `button16`, `button17`, `button18`, `button19`, `button20`, `button21`, `button22`, `button23`, `button24`, `button25`, `button26`, `button27`, `button28`, `button29`, `button30`) VALUES (1, '#ffffff', '#e6e6e6', '#333333', '#8c8c8c', '#adadad', '#0088cc', '#0044cc', '#ffffff', '#2e6da4', '#204d74', '#5cb85c', '#449d44', '#ffffff', '#4cae4c', '#398439', '#5bc0de', '#2f96b4', '#ffffff', '#46b8da', '#269abc', '#fbb450', '#f89406', '#ffffff', '#eea236', '#d58512', '#ee5f5b', '#bd362f', '#ffffff', '#d43f3a', '#ac2925')");
