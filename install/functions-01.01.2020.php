...
#$transaction->addQuery("DROP TABLE IF EXISTS `" . PREFIX . "navigation_sub`"); #navigation_sub // wird gelöscht und neu installiert
...
#$transaction->addQuery("ALTER TABLE `" . PREFIX . "servers` CHANGE `game` `game` VARCHAR( 10 ) NOT NULL");#char(3) auf VARCHAR 10 geändert
...
// dateien löschen alt 68 neu 36 prüfen!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
# widgets noch mit navi anpassen !!!!!!!!!!!!!!!!!
...
/*  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` DROP `news`");
  ...
  #$transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` DROP `spamapikey`");
  #$transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` DROP `spamapihost`");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD spamapiblockerror int(1) NOT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD title varchar(255) NOT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD startpage varchar(255) NOT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD register_per_ip int(1) DEFAULT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD spam_check int(1) DEFAULT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD detect_language int(1) DEFAULT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD date_format varchar(255) NOT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD time_format varchar(255) NOT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD spammaxposts int(11) NOT NULL");
  $transaction->addQuery("ALTER TABLE `" . PREFIX . "settings` ADD modrewrite int(1) NOT NULL");
