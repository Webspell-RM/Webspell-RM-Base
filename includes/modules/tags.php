...
if (isset($_GET[ 'tag' ])) {
    ...
    if ($sql->num_rows) {
        ...
        foreach ($data as $entry) {
            ...
            $template = $tpl->loadTemplate("tags","search_tags", $data_array);
        echo $template;
    ...
    $template = $tpl->loadTemplate("tags","search_tags_no_result", $data_array);
        echo $template;
    }
} else {
