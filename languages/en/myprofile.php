...
$language_array = array(
    ...
    'mail_text'               => 'Hello %nickname%!<p>You changed your email at %pagetitle% (%homepage_url%) successfully.</p><p>To finish your email change you have to activate your email address by clicking the following link:</p><p>%activationlink%</p><p>Thank you for your interest</p>%pagetitle% - %homepage_url%',
    'mainboard'               => 'Mainboard',
    'male'                    => 'Male',
    'monitor'                 => 'Monitor',
    'mouse'                   => 'Mouse',
    ...
    'no'                      => 'No',
    'not_logged_in'           => 'You have to be logged in to view your profile!<br><br>&#8226; <a href="index.php?site=register" class="alert-link">register now</a><br>&#8226; <a href="index.php?site=login" class="alert-link">log in</a>',
