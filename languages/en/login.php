...
/* do not edit above this line */
    ...
    'galleries' => 'galleries',
    'login_titel' => '<i class="fas fa-sign-in-alt"></i> Login',
    'login' => '<i class="fas fa-sign-in-alt"></i> login',
    'logout' => 'logout',
    'lost_password' => '<i class="fas fa-key"> lost password?',
    'messenger' => 'messenger',
    'n_a'=>'n/a',
    'overview' => 'overview',
    'register' => 'Register',
    ...
    'one_new_message'=>'<span style="color: #D7171A">You have a new messag.</span>',
    'x_new_message'=>'<button type="button" class="btn btn-primary"><span style="color: #D7171A">You have %new_messages% new messages.</span></button>',
    'info' => 'Please log in and go!',
